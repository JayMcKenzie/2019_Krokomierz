...
public class Database_cars extends SQLiteOpenHelper {
    ...
    private static final String DB_CREATE =
            "CREATE TABLE " + TABLE_NAME + "( " + ID_COL + " INTEGER PRIMARY KEY AUTOINCREMENT" + ", " +
                    DATE_COL + ", " + STEPS_COL + "," + CAR_COL + "," + REQUIRED_COL + "," + FUELED_COL + ");";
    ...
    public boolean insertData(String date, String steps, String car, String required, String fueled) {
    ...
    public boolean updateData(String date, String steps, String car, String required, String fueled) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValue = new ContentValues();
        contentValue.put(DATE_COL, date);
        contentValue.put(STEPS_COL, steps);
